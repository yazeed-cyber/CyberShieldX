...
from src.dashboard.face_id_engine import face_id_gate
            ...
            if lockout_active(st.session_state.lockout_until):
                ...
                try:
                    ...
                    if verified:
                        ...
                        try:
                            face_id_gate(user_for_face)
                        except Exception as e:
                            st.warning(f"Face ID camera unavailable in VM: {e}")

                        st.success("Face ID MFA step passed.")
